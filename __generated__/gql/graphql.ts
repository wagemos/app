...
export type AccountsByIdsQuery = {
  __typename?: 'Query'
  accountsByIds: Array<{
    __typename?: 'AbstractAccount'
    id: string
    ...
    manager: string
    accountId: { __typename?: 'AccountId'; sequence: number }
    info: {
      __typename?: 'AccountInfo'
      name: string
    ...
    subAccounts: Array<{
      ...
      modules: Array<{ __typename?: 'AccountModule'; id: string }>
    }>
  }>
}

export const AccountsByIdsDocument = {
  kind: 'Document',
  definitions: [
    {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'proxy' } },
...
} as unknown as DocumentNode<AccountsByIdsQuery, AccountsByIdsQueryVariables>
